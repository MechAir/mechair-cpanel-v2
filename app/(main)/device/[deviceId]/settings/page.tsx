    ...
    <div className="px-3 sm:px-8 py-4 sm:py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3"><label className="text-gray-700 text-sm sm:text-base font-medium sm:w-48 sm:shrink-0">Temp High Limit:</label><div className="flex items-center gap-2"><input type="number" step={0.5} min={-40} max={60} value={settings.tempHigh} readOnly={readOnly} disabled={readOnly} onChange={e => { if (e.target.value === '' || e.target.value === '-') return; const v = parseFloat(e.target.value); if (!isNaN(v) && v >= -40 && v <= 60) update({ tempHigh: v }) }} onBlur={e => { if (e.target.value === '' || e.target.value === '-') update({ tempHigh: 0 }) }} className={`w-28 text-center text-lg font-semibold text-gray-800 border-2 border-[#7C3AED] rounded-xl py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/40 bg-gray-50 ${readOnly ? 'opacity-70 cursor-not-allowed' : ''}`} /><span className="bg-[#7C3AED] text-white text-sm font-bold px-4 py-2.5 rounded-xl min-w-[52px] text-center">°C</span></div></div>
          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3"><label className="text-gray-700 text-sm sm:text-base font-medium sm:w-48 sm:shrink-0">Temp Low Limit:</label><div className="flex items-center gap-2"><input type="number" step={0.5} min={-40} max={60} value={settings.tempLow} readOnly={readOnly} disabled={readOnly} onChange={e => { if (e.target.value === '' || e.target.value === '-') return; const v = parseFloat(e.target.value); if (!isNaN(v) && v >= -40 && v <= 60) update({ tempLow: v }) }} onBlur={e => { if (e.target.value === '' || e.target.value === '-') update({ tempLow: 0 }) }} className={`w-28 text-center text-lg font-semibold text-gray-800 border-2 border-[#7C3AED] rounded-xl py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/40 bg-gray-50 ${readOnly ? 'opacity-70 cursor-not-allowed' : ''}`} /><span className="bg-[#7C3AED] text-white text-sm font-bold px-4 py-2.5 rounded-xl min-w-[52px] text-center">°C</span></div></div>
  ...
  return (
    <div className="px-3 sm:px-8 py-4 sm:py-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-12 gap-y-6">
        ...
        <div className="space-y-5">
          <p className="text-xs font-semibold text-gray-400 uppercase tracking-widest">Temperature Limits</p>
          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3"><label className="text-gray-700 text-sm sm:text-base font-medium sm:w-48 sm:shrink-0">Temp High Limit:</label><div className="flex items-center gap-2"><input type="number" step={0.5} min={-50} max={100} value={cur.tempHigh ?? 30} readOnly={readOnly} disabled={readOnly} onChange={e => { if (e.target.value === '' || e.target.value === '-') return; const v = parseFloat(e.target.value); if (!isNaN(v) && v >= -50 && v <= 100) update({ tempHigh: v }) }} onBlur={e => { if (e.target.value === '' || e.target.value === '-') update({ tempHigh: 0 }) }} className={`w-28 text-center text-lg font-semibold text-gray-800 border-2 border-[#2B8DB8] rounded-xl py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[#2B8DB8]/40 bg-gray-50 ${readOnly ? 'opacity-70 cursor-not-allowed' : ''}`} /><span className="bg-[#2B8DB8] text-white text-sm font-bold px-4 py-2.5 rounded-xl min-w-[52px] text-center">°C</span></div></div>
          <div className="flex flex-col sm:flex-row sm:items-center gap-1.5 sm:gap-3"><label className="text-gray-700 text-sm sm:text-base font-medium sm:w-48 sm:shrink-0">Temp Low Limit:</label><div className="flex items-center gap-2"><input type="number" step={0.5} min={-50} max={100} value={cur.tempLow ?? -5} readOnly={readOnly} disabled={readOnly} onChange={e => { if (e.target.value === '' || e.target.value === '-') return; const v = parseFloat(e.target.value); if (!isNaN(v) && v >= -50 && v <= 100) update({ tempLow: v }) }} onBlur={e => { if (e.target.value === '' || e.target.value === '-') update({ tempLow: 0 }) }} className={`w-28 text-center text-lg font-semibold text-gray-800 border-2 border-[#2B8DB8] rounded-xl py-2.5 px-3 focus:outline-none focus:ring-2 focus:ring-[#2B8DB8]/40 bg-gray-50 ${readOnly ? 'opacity-70 cursor-not-allowed' : ''}`} /><span className="bg-[#2B8DB8] text-white text-sm font-bold px-4 py-2.5 rounded-xl min-w-[52px] text-center">°C</span></div></div>
